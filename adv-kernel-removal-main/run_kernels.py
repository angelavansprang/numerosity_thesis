...
def load_ViTpatches(dataset, objective):
    for split in ["train", "val", "test"]:
        file_name_patches = f"../malevic-master/data/{dataset}/representations/{dataset}_{split}_patches.pickle"
        with open(file_name_patches, "rb") as f:
            objectpatches = pickle.load(f)

        file_name_reprs = f"../malevic-master/data/{dataset}/representations/{dataset}_{split}_visual.pickle"
